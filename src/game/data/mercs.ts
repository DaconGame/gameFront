...
export const MERC_COMBAT: Record<string, MercCombat> = {
  sword: { id: "sword", role: "melee", atk: 15, range: 70, cooldownMs: 800, scale: 3, feetRatio: 0.58 },
  bow: {
    id: "bow",
    role: "ranged",
    atk: 10,
  ...
  cleric: { id: "cleric", role: "heal", atk: 0, range: 0, cooldownMs: 5000, heal: 5, scale: 3, feetRatio: 0.58 },
};
